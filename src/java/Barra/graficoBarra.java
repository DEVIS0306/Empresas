    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    data.setValue(rs.getInt(1), rs.getString(2), rs.getString(2));
                }
                JFreeChart cha = ChartFactory.createBarChart3D("Empleados", "Etapas", "Cantidad", data, PlotOrientation.VERTICAL, true, true, true);
